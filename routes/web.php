...
Route::get('/', 'Dashboard\DashboardController@index');
  ...
  Route::get('transaksi-inap-json', 'Keuangan\TransaksiInapController@transaksiJSON')->name('transaksiinap.dataJSON');
  Route::post('edit-transaksi-inap', 'Keuangan\TransaksiInapController@updateData')->name('keuangan.editTransaksiInap');
  Route::get('deleteTransaksiInap', 'Keuangan\TransaksiInapController@destroy')->name('transaksiinap.delete');

  Route::get('transaksi-jalan', 'Keuangan\TransaksiJalanController@index');
  Route::post('add-transaksi-jalan', 'Keuangan\TransaksiJalanController@store')->name('transaksi.addTransaksiJalan');
  ...
  Route::get('deleteTransaksiJalan', 'Keuangan\TransaksiJalanController@destroy')->name('transaksijalan.delete');
