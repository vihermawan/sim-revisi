					...
					<div class="col-lg-3"></div>
						<div class="col-lg-6">
							...
							<img src="https://indok3ll.com/wp-content/uploads/2018/12/kesehatan-icon.png" class="mb-4" width="120px">							
                                ...
                                <h1 class="font-weight-semibold">REGISTER PSKS</h1>
								<div class="card-body">
										...
										<fieldset class="mb-0">
											<div class="form-group">
												<div class="form-group form-group-feedback form-group-feedback-left">
													<input id="NikPSKS" type="text" class="form-control @error('NikPSKS') is-invalid @enderror" name="NikPSKS" value="{{ old('NikPSKS') }}" required autocomplete="NikPSKS" placeholder="Nik PSKS">
                                                    <div class="form-control-feedback form-control-feedback-lg">
														<i class="icon-user"></i>
													</div>
                                                </div>
                                                <div class="form-group form-group-feedback form-group-feedback-left">
													<input id="NamaPSKS" type="text" class="form-control @error('NamaPSKS') is-invalid @enderror" name="NamaPSKS" value="{{ old('NamaPSKS') }}" required autocomplete="NamaPSKS" placeholder="Nama PSKS">
                                                    <div class="form-control-feedback form-control-feedback-lg">
														<i class="icon-user"></i>
													</div>
												</div>
												...
												<button class="btn btn-primary btn-lg px-5 py-2 font-weight-bold">REGISTER</button><br><br>
												<a href="{{ route('login') }}"><button type="button" class="btn btn-outline btn-lg alpha-primary text-primary">Sudah Punya Akun</button></a>
												<br><br>
												<p>PUSDATIN | Kementerian Sosial RI 2019</p>
											</div>
										</fieldset>
									</form>
								</div>
